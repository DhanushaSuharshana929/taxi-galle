...
$COUNT_EXCURSION = count(Excursion::all());
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <a href="create-tour-package-normal.php"><button type="button" class="list-group-item">Add new</button></a>
                                    <a href="manage-tour-package-normal.php"><button type="button" class="list-group-item">Manage</button></a>
                                    <a href="arrange-tour-package-normal-photos.php"><button type="button" class="list-group-item">Arrange</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
