            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Create One Day Tour Package</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="manage-one-day-tour-package.php">
                            ...
                            <div class="body">
                                <form class="form-horizontal"  method="post" action="post-and-get/one-day-tour-package.php" enctype="multipart/form-data"> 
