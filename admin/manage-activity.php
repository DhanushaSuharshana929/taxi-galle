...
<html>
    ...
    <body class="theme-red">
                            ...
                            <div class="body">
                                ...
                                <div>
                                        ...
                                        if (count($ACTIVITY) > 0) {
                                            ...
                                            ?> 
                                            <b style="padding-left: 15px;">No One Day Tour Packages in the database.</b> 
                                        <?php } ?> 
        ...
        <script src="js/demo.js"></script>
        <script src="delete/js/activity.js" type="text/javascript"></script>
    </body>
