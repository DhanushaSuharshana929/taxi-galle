                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0"> 
                                                            <tbody>
                                                                <tr><td>
                                                                                    ...
                                                                                    <td width="393">
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 25px;">
                                                                                            <tbody><tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td height="30"><img src="https://ci3.googleusercontent.com/proxy/TYJ_zOrASsobTeDz_yvavwzKTAX7JrJGTJyCeRScsDTzGF54pub4t0wIRdM4iU3Avx31-3oG9cLkfEWyndCW6CIvp3jtKfO3KpewNC4=s0-d-e1-ft#https://synotec.lk/sites-mail-files/PROMO-GREEN2_01_04.jpg" alt="" class="CToWUd" width="393" height="30" border="0"></td>
                                                                                                </tr>
                                                                                            </tbody></table>
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    <td style="font-size:20px;color:#33468f;line-height:28px;font-family:Arial,Helvetica,sans-serif;padding-bottom:20px;padding-top: 0px;font-weight: 600;" align="left"> ' . $mailTitle . '  </td> 
                                                                </tr>
                                                            </tbody> 
                                                        </table> 
                                                ...
                                                <tr> 
                                                    <td> 
                                                        <table style="padding:0" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
                                                            <tbody> 
                                                                <tr> 
                                                                    <td style="padding:0px 0 7px;color:#9a9a9a;text-align:left;font-family:Arial,Helvetica,sans-serif;font-size:12px" align="left"> <p style="line-height:18px;margin:0;padding:0">Solution By : <a href="https://synotec.lk/">Synotec Holdings (Pvt) Ltd</a></p> </td> 
                                                                </tr> 
                                                                <tr></tr> 
                                                            </tbody> 
                                                        </table> </td> 
                                                ...
                                                <tr> 
                                                    <td style="border:1px solid #dcdee3;padding:20px;background-color:#fff;width:600px" width="600px" bgcolor="#ffffff" align="center"> 
                                                        ...
                                                        <table style="background-color:#f5f7fa" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#F5F7FA"> 
                                                            <tbody> 
                                                                <tr> 
                                                                    <td style="word-wrap:break-word;font-size:14px;color:#333;line-height:18px;font-family:Arial,Helvetica,sans-serif;padding:10px 20px" align="left"> <p> You have a new enquiry from website.Kindly request your attention on this matter.The details of the enquiry are shown bellow</p></td> 
                                                                </tr> 
                                                            </tbody> 
                                                        </table> 
                                                    </td> 
