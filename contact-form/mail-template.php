                                                            ...
                                                            <tbody>
                                                                <tr><td>
                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody><tr>
                                                                                    <td width="182">
                                                                                        <a href="' . $site_link . '" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://www.gallecabsandtours.com&amp;source=gmail&amp;ust=1574393192616000&amp;usg=AFQjCNGNM8_Z7ZMe7ndwFlJuHEP29nDd3Q"> <img src="https://drive.google.com/uc?export=view&id=1pSwuuEUO_ZwYy_p31ag9aShrNswiZEF4' . $site_link . '/distance/img/logo.png" alt="" class="CToWUd" border="0">
                                                                                        </a>
                                                                                    </td>
                                                                                    <td width="393">
                                                            ...
                                                            <tbody> 
                                                                <tr> 
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <font style="font-family:Verdana,Geneva,sans-serif;color:#68696a;font-size:14px">
                                                                                Phone Number : <a href="mailto:'. $visitor_contact .'" rel="noreferrer" target="_blank">' . $visitor_contact . '</a>
                                                                            </font>
                                                                        </li>
                                                                        <li>
                                                                            <font style="font-family:Verdana,Geneva,sans-serif;color:#68696a;font-size:14px">
                                                                                Country : <a href="mailto:'. $country .'" rel="noreferrer" target="_blank">' . $country . '</a>
                                                                            </font>
                                                                        </li>
                                                                        <li>
                                                                            <font style="font-family:Verdana,Geneva,sans-serif;color:#68696a;font-size:14px">
                                                                                Subject : <a href="mailto:'. $subject .'" rel="noreferrer" target="_blank">' . $subject . '</a>
                                                                            </font>
                                                                        </li>
                                                                    </ul>
                                                                </tr> 
